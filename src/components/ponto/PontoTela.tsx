// ============================================================
// Casca das telas do módulo de Ponto
// ------------------------------------------------------------
// Irmã de RhTela, e separada dela de propósito: RhTela exige o módulo
// `rh` antes de olhar o perfil, e o Ponto não pode herdar essa trava.
// Bater ponto é de quem está logado — inclusive do pessoal de campo,
// que não tem o módulo de RH. Se o Ponto reaproveitasse a casca do RH,
// a tela mais usada do sistema ficaria trancada para quem mais precisa
// dela.
//
// Por isso o módulo exigido aqui é um parâmetro, e o padrão é nenhum.
// ============================================================
...
export function PontoTela({
  ...
  titulo: string;
  resumo: string;
  /** Perfis (em minúsculas) que enxergam esta tela. Lista vazia = todo mundo logado. */
  ...
  const perfilOk = perfis.length === 0 || perfis.includes(user.perfil.toLowerCase());
        ...
        <Card className="p-8">
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Os dados desta tela já são gravados pelos jobs. A interface entra na{" "}
              {etapa ?? "próxima etapa"}.
            </p>
