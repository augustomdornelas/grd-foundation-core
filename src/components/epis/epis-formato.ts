...
// Data digitada em DD/MM/AAAA: as funções moram em @/lib/formato, que
// Projetos também usa; ficam reexportadas aqui para as abas de EPIs.
export { mascaraDataBr, dataBrParaIso, dataLocalBr } from "@/lib/formato";
